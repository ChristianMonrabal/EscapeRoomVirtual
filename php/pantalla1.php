...
<body>
    ...
    <header>
        ...
        <ul class="navbar">
            ...
            <li><a href="#"><a onclick="toggleMenu()">Pista</button></a></li>
        </ul>
    </header>
    <!--Pista-->
    <div id="menu">
     ...
     <div class="acertijo1">
        <form class="formulario" action="./pantalla1.php" method="post">
            <h3>Comprueba que el firewall este activado</h3>
            <br>
            <input type="text" name="resp1" placeholder="Escribe el comando necesario..." required>
            <br>
            <br>
