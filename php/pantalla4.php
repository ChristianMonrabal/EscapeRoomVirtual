...
// Creamos la sesion
session_start();
$_SESSION['pantalla4_completado'] = false;
if (!isset($_SESSION['pantalla3_completado']) || $_SESSION['pantalla3_completado'] != true) {
...
<header>
  ...
  <form class="formulario" method="post">
    <h3>Reinicia las interfaces de red</h3>
    <br>
